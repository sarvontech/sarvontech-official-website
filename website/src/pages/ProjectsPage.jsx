...
import { ArrowRight, FolderKanban, Sparkles, ExternalLink, Loader2 } from 'lucide-react';
...
export default function ProjectsPage({ onOpenConsultation }) {
  ...
  return (
    <div className="pt-28 pb-20 bg-[var(--color-bg-primary)] transition-colors duration-200 min-h-screen">
      <SEOHead 
